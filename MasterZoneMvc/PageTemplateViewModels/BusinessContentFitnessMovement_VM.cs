...
{
    public class BusinessContentFitnessMovement_VM
    {
        ...
        public HttpPostedFile FitnessImage { get; set; }
        ...
        public Error_VM ValidInformation()
        {
             ...
             if (FitnessImage != null)
            {
                ...
                if (!validImageTypes.Contains(FitnessImage.ContentType))
                {
                    isValidImage = false;
                    sb.Append("Invalid image type. Please select a JPEG, PNG");
                }
                else if (FitnessImage.ContentLength > 2 * 1024 * 1024) // 10 MB
                {
                    isValidImage = false;
    ...
    public class BusinessContentFitnessMovementDetail_VM
    {
        public long Id { get; set; }
        public long UserLoginId { get; set; }
        public long ProfilePageTypeId { get; set; }
        ...
        public string FitnessImageWithPath { get; set; }
        public int Mode { get; set; }
    }
}