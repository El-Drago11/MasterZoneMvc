...
{
    //public class SuperAdminSponsorViewModel
    //{
    ...
    public class SuperAdminSponsorViewModel
    {
        ...
        public Error_VM ValidInformation()
        {
            ...
            if (String.IsNullOrEmpty(SponsorTitle)) { sb.Append(Resources.SuperAdminPanel.SponsorTitleRequired); vm.Valid = false; }
            else if (String.IsNullOrEmpty(SponsorLink)) { sb.Append(Resources.SuperAdminPanel.SponsorLinkRequired); vm.Valid = false; }
            //else if (String.IsNullOrEmpty(SponsorLink)) { sb.Append(Resources.SuperAdminPanel.ValidLinkRequired); vm.Valid = false; }
    ...
    public class SuperAdminSponsor_VisitorVM
    {
        public long Id { get; set; }
        public string SponsorTitle { get; set; }
        public string SponsorIcon { get; set; }
