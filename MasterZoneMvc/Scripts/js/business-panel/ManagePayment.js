...
$(document).ready(function () {
    $('#btnAddStaff').click(function () {
        ...
        document.getElementById("pageTextchange").innerHTML = "Add Payment";
        document.getElementById("pageStageChange").innerHTML = "Add Payment";

    });
});


function EditManagePayment() {
    $('#sectionAddStaff').show();
    $('#sectionViewStaff').hide();
    document.getElementById("myText").innerHTML = "Edit Payment";
    document.getElementById("ChangeUpdateText").innerHTML = "Update";
    document.getElementById("pageTextchange").innerHTML = "Edit Payment";
    document.getElementById("pageStageChange").innerHTML = "Edit Payment";
    $('#ChangeUpdateText').show();
    $('#btnAddStaff').hide();
    $(".error-class").html('');
    $('#btnAddStaff').click(function () {
        document.getElementById("myText").innerHTML = "Add Payment";
...
function ResetAddView() {
    ...
    $('#btnAddStaff').show();
    document.getElementById("pageTextchange").innerHTML = "Payment";
    document.getElementById("pageStageChange").innerHTML = "Payment";
    $(".error-class").html('');
}
