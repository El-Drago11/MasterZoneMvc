...
$(document).ready(function () {
    $('#btnAddStaff').click(function () {
        ...
        document.getElementById("pageTextchange").innerHTML = "Add Exam";
        document.getElementById("pageStageChange").innerHTML = "Add Exam";
...
function EditExam() {
    $('#sectionAddStaff').show();
    $('#sectionViewStaff').hide();
    document.getElementById("myText").innerHTML = "Edit Exam";
    document.getElementById("ChangeUpdateText").innerHTML = "Update";
    document.getElementById("pageTextchange").innerHTML = "Edit Exam";
    document.getElementById("pageStageChange").innerHTML = "Edit Exam";
    $('#ChangeUpdateText').show();
    $('#btnAddStaff').hide();
    $(".error-class").html('');
    $('#btnAddStaff').click(function () {
        document.getElementById("myText").innerHTML = "Add Exam";
...
function ResetAddView() {
    ...
    document.getElementById("pageStageChange").innerHTML = "Exam";
    $(".error-class").html('');
}
