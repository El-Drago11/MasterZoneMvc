...
function btnSubmitFormClick() {
    ...
    let _leavemessage = $("#txtLeaveMessage").val().trim();
   

    let _error_leavemessage = $("#error_txtLeaveMessage");
    ...
    if (validate_IsEmptyStringInputFieldValue(_leavemessage)) {
        is_valid = false;
        _error_leavemessage.html('Enter Leave Message!');
    }


    if (is_valid) {
        var data = new FormData();
        data.append("LeaveMessage", _leavemessage);
...
$(document).ready(function () {
    $('#btnAddStudent').click(function () {
        ...
        document.getElementById("pageTextchange").innerHTML = "Add Message";
...
function EditMessage() {
    $('#sectionAddStaff').show();
    $('#sectionViewStaff').hide();
    document.getElementById("myText").innerHTML = "Edit Message";
    document.getElementById("ChangeUpdateText").innerHTML = "Update";
    document.getElementById("pageTextchange").innerHTML = "Edit Message";
    document.getElementById("pageStageChange").innerHTML = "Edit Message";
    $('#ChangeUpdateText').show();
    $('#btnAddStudent').hide();
    $(".error-class").html('');
    $('#btnAddStudent').click(function () {
        document.getElementById("myText").innerHTML = "Add Message";
