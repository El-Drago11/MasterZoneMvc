...
$(document).ready(function () {
    $('#btnAddStaff').click(function () {
        ...
        document.getElementById("pageTextchange").innerHTML = "Add Plans";
        document.getElementById("pageStageChange").innerHTML = "Add Plans";
...
function EditPlans() {
    $('#sectionAddStaff').show();
    $('#sectionViewStaff').hide();
    document.getElementById("myText").innerHTML = "Edit Plans";
    document.getElementById("ChangeUpdateText").innerHTML = "Update";
    document.getElementById("pageTextchange").innerHTML = "Edit Plans";
    document.getElementById("pageStageChange").innerHTML = "Edit Plans";
    $('#ChangeUpdateText').show();
    $('#btnAddStaff').hide();
    $(".error-class").html('');
    $('#btnAddStaff').click(function () {
        document.getElementById("myText").innerHTML = "Add Plans";
...
function ResetAddView() {
    ...
    $('#btnAddStaff').show();
    document.getElementById("pageTextchange").innerHTML = "Plans";
    document.getElementById("pageStageChange").innerHTML = "Plans";
    $(".error-class").html('');
}
