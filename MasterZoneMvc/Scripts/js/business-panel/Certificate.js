...
function btnSubmitFormClick() {
    ...
    let _class = $("#txtClass").val().trim();
    let _age = $("#txtAge").val().trim();



    
    let _error_class = $("#error_txtClass");
    ...
    if (validate_IsEmptyStringInputFieldValue(_class)) {
        is_valid = false;
        _error_class.html('Enter class!');
    }

    if (validate_IsEmptyStringInputFieldValue(_age)) {
        is_valid = false;
        _error_age.html('Enter Upload File!');
    }
...
/*$(document).ready(function () {
    $('#btnAddStudent').click(function () {
        ...
        document.getElementById("pageTextchange").innerHTML = "Add Student";
        document.getElementById("pageStageChange").innerHTML = "Add Student";
...
function EditCertificate() {
    $('#sectionAddStaff').show();
    $('#sectionViewStaff').hide();
    document.getElementById("myText").innerHTML = "Edit Certificate";
    ...
    document.getElementById("pageStageChange").innerHTML = "Edit Certificate";
    $('#ChangeUpdateText').show();
    $('#btnAddStudent').hide();
    $(".error-class").html('');
    $('#btnAddStudent').click(function () {
        document.getElementById("myText").innerHTML = "Add Certificate";
...
function ResetAddView() {
    ...
    $('#btnAddStudent').show();
    document.getElementById("pageTextchange").innerHTML = "Certificate";
    document.getElementById("pageStageChange").innerHTML = "Certificate";
    $(".error-class").html('');
}
