...
{
    public class BusinessContentSponsorService
    {
        private MasterZoneDbContext db;
        private StoredProcedureRepository storedProcedureRepository;

        public BusinessContentSponsorService(MasterZoneDbContext dbContext)
        {
            db = dbContext;
        ...
        /// <summary>
        /// Business Sponsor Detail 
        /// </summary>
        /// <param name=""></param>
        /// <returns>To Get Sponsor Detail</returns>
        public BusinessContentSponsorDetail_VM GetBusinessSponsorDetailById(long Id)
        {
            storedProcedureRepository = new StoredProcedureRepository(db);

            return storedProcedureRepository.SP_ManageBusinessContentSponsor_GetSingle<BusinessContentSponsorDetail_VM>(new SP_ManageBusinessContentSponsor_Param_VM()
            {
                Id = Id,
                Mode = 2
            });
        ...
        /// <summary>
        /// Business Sponsor Record Detail Delete By Id
        /// </summary>
        /// <param name="Id"></param>
        /// <returns> To Delete  Business Sponsor Detail</returns>
        public SPResponseViewModel DeleteBusinessSponsor(long Id)
        {
            storedProcedureRepository = new StoredProcedureRepository(db);

            return storedProcedureRepository.SP_InsertUpdateBusinessSponsor_Get<SPResponseViewModel>(new SP_InsertUpdateBusinessSponsor_Params_VM
            {
                Id = Id,
                Mode = 3
        ...
        /// <summary>
        /// Get Business Owners Sponsor Detail By Pagination [Jquery Datatable Pagination]
        /// </summary>
        /// <param name="httpRequestParams"></param>
        /// <param name="_Params_VM"></param>
        /// <returns></returns>
        public JqueryDataTable_Pagination_Response_VM<BusinessContentSponsorDetail_Pagination_VM> GetBusinessSponsorList_Pagination(NameValueCollection httpRequestParams, BusinessContentSponsorDetail_Pagination_SQL_Params_VM _Params_VM)
        {
            ...
            List<BusinessContentSponsorDetail_Pagination_VM> lstBusinessRecords = new List<BusinessContentSponsorDetail_Pagination_VM>();
            ...
            lstBusinessRecords = db.Database.SqlQuery<BusinessContentSponsorDetail_Pagination_VM>("exec sp_ManageBusinessContentSponsor_Pagination @id,@businessOwnerLoginId,@userLoginId,@start,@searchFilter,@pageSize,@sorting,@sortOrder,@mode", queryParams).ToList();

            recordsTotal = lstBusinessRecords.Count > 0 ? lstBusinessRecords[0].TotalRecords : 0;

            JqueryDataTable_Pagination_Response_VM<BusinessContentSponsorDetail_Pagination_VM> jqueryDataTableParamsViewModel = new JqueryDataTable_Pagination_Response_VM<BusinessContentSponsorDetail_Pagination_VM>()
            {
